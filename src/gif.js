...
(function (f) {
    ...
    return function e(t, n, r) {
        ...
        3: [function (require, module, exports) {
            var EventEmitter, browser, extend = function (child, parent) {
